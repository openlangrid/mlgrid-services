...
"""
        ...
        with open(outputPath, mode="w") as f:
            ...
            generated_text = tokenizer.decode(
                output_ids,
                skip_special_tokens=True).rstrip("<EOD|LLM-jp>")
...
if __name__ == "__main__": 
    ...
    parser.add_argument("model", type=str, nargs="?", default="stockmark/stockmark-13b-instruct")
