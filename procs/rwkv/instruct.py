...
args.MODEL_NAME = '/models/RWKV-4-Pile-14B-Instruct-test5-20230329-ctx4096'
args.n_layer = 40
args.n_embd = 5120
args.ctx_len = 1024
args.MODEL_LORA = '/models/rwkv-500-2305010842'
args.lora_r = 0
args.lora_alpha = 16
...
if __name__ == "__main__": 
    ...
    parser.add_argument("--model", type=str, default="/models/RWKV-4-Pile-14B-Instruct-test5-20230329-ctx4096")
